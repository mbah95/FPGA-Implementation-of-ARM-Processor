...
HD_PWD='G:/My Drive/EECE 351/Project/Project/ThirdMilestone/ARM_MultiCycleExpandedInst/ARM_MultiCycleExpandedInst.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ARM_TopLevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ARM_TopLevel.tcl -notrace
