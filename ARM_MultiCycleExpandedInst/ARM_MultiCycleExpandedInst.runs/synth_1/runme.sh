...
HD_PWD='G:/My Drive/EECE 351/Project/Project/ThirdMilestone/ARM_MultiCycleExpandedInst/ARM_MultiCycleExpandedInst.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARM_TopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ARM_TopLevel.tcl
